...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_FAILEDTOSPITUP]                       = COMPOUND_STRING("But it had no resources to spend!"), //not in gen 5+, uses "but it failed"
    [STRINGID_FAILEDTOSWALLOW]                      = COMPOUND_STRING("But it had no resources to spend!"), //not in gen 5+, uses "but it failed"
