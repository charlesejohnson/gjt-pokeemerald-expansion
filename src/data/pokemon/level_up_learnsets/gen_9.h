...
static const struct LevelUpMove sTorchicLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_ARCANE_BLAST),
    LEVEL_UP_MOVE( 1, MOVE_ARCANE_MISSILES),
    LEVEL_UP_MOVE( 1, MOVE_ARCANE_INTELLECT),
    LEVEL_UP_MOVE( 3, MOVE_EMBER),
    LEVEL_UP_MOVE( 3, MOVE_ARCANE_ORB),
    LEVEL_UP_MOVE( 3, MOVE_POLYMORPH),
    LEVEL_UP_MOVE( 3, MOVE_ICE_BLOCK),
    LEVEL_UP_MOVE( 3, MOVE_FROST_NOVA),
    LEVEL_UP_MOVE( 6, MOVE_QUICK_ATTACK),
...
static const struct LevelUpMove sDeathknightLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 5, MOVE_SCOURGE_STRIKE),
    LEVEL_UP_MOVE( 7, MOVE_FURY_CUTTER),
    LEVEL_UP_MOVE( 10, MOVE_DEATH_STRIKE),
    LEVEL_UP_MOVE( 12, MOVE_HOWLING_BLAST),
    LEVEL_UP_MOVE( 16, MOVE_ICEBOUND_FORTITUDE),
    LEVEL_UP_MOVE( 18, MOVE_AMS),
    LEVEL_UP_MOVE( 40, MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE( 45, MOVE_SHADOW_CLAW),
    LEVEL_UP_END
};

static const struct LevelUpMove sDeathknightFrostLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 5, MOVE_SCOURGE_STRIKE),
    LEVEL_UP_MOVE( 7, MOVE_FURY_CUTTER),
    ...
    LEVEL_UP_MOVE( 16, MOVE_ICEBOUND_FORTITUDE),
    LEVEL_UP_MOVE( 18, MOVE_AMS),
    LEVEL_UP_MOVE( 24, MOVE_FROST_STRIKE),
    LEVEL_UP_MOVE( 32, MOVE_BLIZZARD),
    LEVEL_UP_MOVE( 36, MOVE_OBLITERATE),
    LEVEL_UP_MOVE( 40, MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE( 45, MOVE_SHADOW_CLAW),
    LEVEL_UP_MOVE( 55, MOVE_REMORSELESS_WINTER),
    LEVEL_UP_END
};

static const struct LevelUpMove sDeathknightBloodLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 5, MOVE_SCOURGE_STRIKE),
    LEVEL_UP_MOVE( 7, MOVE_FURY_CUTTER),
    ...
    LEVEL_UP_MOVE( 16, MOVE_ICEBOUND_FORTITUDE),
    LEVEL_UP_MOVE( 18, MOVE_AMS),
    LEVEL_UP_MOVE( 24, MOVE_MARROWREND),
    LEVEL_UP_MOVE( 32, MOVE_DANCING_RUNE_WEAPON),
    LEVEL_UP_MOVE( 36, MOVE_CONSUMPTION),
    LEVEL_UP_MOVE( 40, MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE( 45, MOVE_SHADOW_CLAW),
    LEVEL_UP_END
};

static const struct LevelUpMove sDeathknightUnholyLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 5, MOVE_SCOURGE_STRIKE),
    LEVEL_UP_MOVE( 7, MOVE_FURY_CUTTER),
    ...
    LEVEL_UP_MOVE( 16, MOVE_ICEBOUND_FORTITUDE),
    LEVEL_UP_MOVE( 18, MOVE_AMS),
    LEVEL_UP_MOVE( 24, MOVE_SUMMON_GARGOYLE),
    LEVEL_UP_MOVE( 32, MOVE_DARK_TRANSFORMATION),
    LEVEL_UP_MOVE( 36, MOVE_ARMY_OF_THE_DEAD),
    LEVEL_UP_MOVE( 40, MOVE_NIGHT_SLASH),
    LEVEL_UP_MOVE( 45, MOVE_SHADOW_CLAW),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMageLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 10, MOVE_TELEPORT),
    LEVEL_UP_MOVE( 10, MOVE_ARCANE_MISSILES),
    LEVEL_UP_MOVE( 12, MOVE_DOUBLE_TEAM),
    LEVEL_UP_MOVE( 14, MOVE_FIRE_SPIN),
    LEVEL_UP_MOVE( 18, MOVE_ICY_WIND),
    LEVEL_UP_MOVE( 18, MOVE_ARCANE_INTELLECT),
    LEVEL_UP_MOVE( 22, MOVE_PSYBEAM),
    LEVEL_UP_END
};

static const struct LevelUpMove sMageFrostLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    LEVEL_UP_MOVE( 1, MOVE_CONFUSION),
    LEVEL_UP_MOVE( 6, MOVE_EMBER),
    LEVEL_UP_MOVE( 9, MOVE_POWDER_SNOW),
    ...
    LEVEL_UP_MOVE( 18, MOVE_ICY_WIND),
    LEVEL_UP_MOVE( 22, MOVE_PSYBEAM),
    LEVEL_UP_MOVE( 24, MOVE_ICE_LANCE),
    LEVEL_UP_MOVE( 28, MOVE_HAIL),
    LEVEL_UP_MOVE( 28, MOVE_FROST_NOVA),
    LEVEL_UP_MOVE( 32, MOVE_BLIZZARD),
    LEVEL_UP_MOVE( 41, MOVE_ICE_BLOCK),    
    LEVEL_UP_END
};

static const struct LevelUpMove sMageFireLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    LEVEL_UP_MOVE( 1, MOVE_CONFUSION),
    LEVEL_UP_MOVE( 6, MOVE_EMBER),
    LEVEL_UP_MOVE( 9, MOVE_POWDER_SNOW),
    ...
    LEVEL_UP_MOVE( 18, MOVE_ICY_WIND),
    LEVEL_UP_MOVE( 22, MOVE_PSYBEAM),
    LEVEL_UP_MOVE( 24, MOVE_BLAST_WAVE),
    LEVEL_UP_MOVE( 28, MOVE_PYROBLAST),
    LEVEL_UP_MOVE( 32, MOVE_PHOENIX_FLAMES),
    LEVEL_UP_MOVE( 36, MOVE_FLAMETHROWER),
...
static const struct LevelUpMove sMageArcaneLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_POUND),
    LEVEL_UP_MOVE( 1, MOVE_CONFUSION),
    LEVEL_UP_MOVE( 6, MOVE_EMBER),
    LEVEL_UP_MOVE( 9, MOVE_POWDER_SNOW),
    ...
    LEVEL_UP_MOVE( 18, MOVE_ICY_WIND),
    LEVEL_UP_MOVE( 22, MOVE_PSYBEAM),
    LEVEL_UP_MOVE( 24, MOVE_ARCANE_BLAST),
    LEVEL_UP_MOVE( 28, MOVE_PSYCHIC_TERRAIN),
    LEVEL_UP_MOVE( 28, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE( 30, MOVE_POLYMORPH),
    LEVEL_UP_MOVE( 32, MOVE_LIGHT_SCREEN),
    LEVEL_UP_MOVE( 36, MOVE_ARCANE_ORB),    
    LEVEL_UP_END
};
