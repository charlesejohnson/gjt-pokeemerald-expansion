...
static const struct LevelUpMove sDeathknightLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCOURGE_STRIKE),
    LEVEL_UP_MOVE( 2, MOVE_DEATH_STRIKE),
    LEVEL_UP_MOVE( 3, MOVE_ICEBOUND_FORTITUDE),
    LEVEL_UP_MOVE( 4, MOVE_HOWLING_BLAST),
    LEVEL_UP_MOVE( 6, MOVE_AMS),
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 5, MOVE_FURY_CUTTER),
...
static const struct LevelUpMove sDeathknightFrostLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 4, MOVE_HOWLING_BLAST),
    LEVEL_UP_MOVE( 6, MOVE_AMS),
    LEVEL_UP_MOVE( 10, MOVE_BLOOD_BOIL),
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 5, MOVE_FURY_CUTTER),
    LEVEL_UP_MOVE(10, MOVE_METAL_CLAW),
