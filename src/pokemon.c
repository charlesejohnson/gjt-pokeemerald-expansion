...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(DEATHKNIGHT_FROST),
    HOENN_TO_NATIONAL(DEATHKNIGHT_BLOOD),
    HOENN_TO_NATIONAL(DEATHKNIGHT_UNHOLY),
    HOENN_TO_NATIONAL(MAGE),
    HOENN_TO_NATIONAL(MAGE_FROST),
    HOENN_TO_NATIONAL(MAGE_FIRE),
    HOENN_TO_NATIONAL(MAGE_ARCANE),
};
