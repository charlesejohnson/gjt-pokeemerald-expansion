...
enum {
    ...
    NATIONAL_DEX_DEATHKNIGHT,
    NATIONAL_DEX_DEATHKNIGHT_FROST,
    NATIONAL_DEX_DEATHKNIGHT_BLOOD,
    NATIONAL_DEX_DEATHKNIGHT_UNHOLY,
    NATIONAL_DEX_MAGE,
    NATIONAL_DEX_MAGE_FROST,
    NATIONAL_DEX_MAGE_FIRE,
    NATIONAL_DEX_MAGE_ARCANE,
};
...
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI
    ...
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_MAGE_ARCANE
...
enum {
    ...
    HOENN_DEX_JIRACHI,
    HOENN_DEX_DEOXYS,
    HOENN_DEX_DEATHKNIGHT,
    HOENN_DEX_DEATHKNIGHT_FROST,
    HOENN_DEX_DEATHKNIGHT_BLOOD,
    HOENN_DEX_DEATHKNIGHT_UNHOLY,
    HOENN_DEX_MAGE,
    HOENN_DEX_MAGE_FROST,
    HOENN_DEX_MAGE_FIRE,
    HOENN_DEX_MAGE_ARCANE,
};

#define HOENN_DEX_COUNT (HOENN_DEX_MAGE_ARCANE + 1)
