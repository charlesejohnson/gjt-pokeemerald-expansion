...
extern const u8 BattleScript_EffectIceBlock[];
extern const u8 BattleScript_EffectSubstituteAndSleep[];
...
extern const u8 BattleScript_EffectSpender[];
...
extern const u8 BattleScript_EffectIcebound[];
